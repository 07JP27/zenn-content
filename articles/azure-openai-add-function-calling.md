...
Azure Open AIの場合は本家Open AIとは異なり、開発者各自が[Azure Open AIのリソースをデプロイし、その中にベースモデルからのデプロイメントを配置する準備](https://learn.microsoft.com/ja-jp/azure/ai-services/openai/how-to/create-resource?pivots=web-portal)が必要になります。そのためエンドポイントは以下のように各環境ごとの変数を含む形なります。
```
