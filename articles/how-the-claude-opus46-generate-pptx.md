...
なお、今回はSkillが肝になっていることが分かりましたが、Anthropicのpptx Skillには以下のライセンスが適用されており、このSkillをClaude以外の他のLLMサービスにコピーして利用することはできません。
https://github.com/anthropics/skills/blob/main/skills/pptx/LICENSE.txt
